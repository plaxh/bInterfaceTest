...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.8.91 2019-09-15 10:45:43 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_SOAP_ENC__string:
		return soap_in_SOAP_ENC__string(soap, tag, NULL, "SOAP-ENC:string");
	...
	*type = 0;
	...
	{	const char *t = soap->type;
		...
		{	*type = SOAP_TYPE_SOAP_ENC__string;
			return soap_in_SOAP_ENC__string(soap, tag, NULL, NULL);
		}
...
{	(void)type;
	...
	case SOAP_TYPE_ns1__invokeResponse:
		return (void*)soap_instantiate_ns1__invokeResponse(soap, -1, type, arrayType, n);
	case SOAP_TYPE_ns1__invoke:
		return (void*)soap_instantiate_ns1__invoke(soap, -1, type, arrayType, n);
#ifndef WITH_NOGLOBAL
...
SOAP_FMAC3 int SOAP_FMAC4 soap_fdelete(struct soap *soap, struct soap_clist *p)
{
	...
	case SOAP_TYPE_ns1__invokeResponse:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct ns1__invokeResponse*>(p->ptr), struct ns1__invokeResponse);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct ns1__invokeResponse*>(p->ptr), struct ns1__invokeResponse);
		break;
	case SOAP_TYPE_ns1__invoke:
		if (p->size < 0)
			SOAP_DELETE(soap, static_cast<struct ns1__invoke*>(p->ptr), struct ns1__invoke);
		else
			SOAP_DELETE_ARRAY(soap, static_cast<struct ns1__invoke*>(p->ptr), struct ns1__invoke);
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
		if (p->size < 0)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_finsert(struct soap *soap, int t, int tt, void *p, size_t index, const void *q, void **x)
{
	...
	case SOAP_TYPE_std__string:
		...
		*(std::string*)p = *(std::string*)q;
		break;
	case SOAP_TYPE_ns1__invokeResponse:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct ns1__invokeResponse type=%d location=%p object=%p\n", t, p, q));
		*(struct ns1__invokeResponse*)p = *(struct ns1__invokeResponse*)q;
		break;
	case SOAP_TYPE_ns1__invoke:
		DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Copy struct ns1__invoke type=%d location=%p object=%p\n", t, p, q));
		*(struct ns1__invoke*)p = *(struct ns1__invoke*)q;
		break;
#ifndef WITH_NOGLOBAL
	case SOAP_TYPE_SOAP_ENV__Header:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__invoke(struct soap *soap, const struct ns1__invoke *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_SOAP_ENC__string(soap, &a->_xmlData);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__invoke(struct soap *soap, const char *tag, int id, const struct ns1__invoke *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns1__invoke), type))
		return soap->error;
	if (soap_out_SOAP_ENC__string(soap, "xmlData", -1, &a->_xmlData, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 struct ns1__invoke * SOAP_FMAC4 soap_in_ns1__invoke(struct soap *soap, const char *tag, struct ns1__invoke *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	(void)type; /* appease -Wall -Werror */
	a = (struct ns1__invoke*)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns1__invoke, sizeof(struct ns1__invoke), soap->type, soap->arrayType, soap_instantiate, soap_fbase);
	if (!a)
		return NULL;
	...
	if (soap->body && *soap->href != '#')
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			{	if (soap_in_SOAP_ENC__string(soap, NULL, &a->_xmlData, "SOAP-ENC:string"))
				{	soap_flag__xmlData--;
					continue;
				}
			}
	...
	{	a = (struct ns1__invoke *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns1__invoke, SOAP_TYPE_ns1__invoke, sizeof(struct ns1__invoke), 0, soap_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns1__invoke * SOAP_FMAC2 soap_instantiate_ns1__invoke(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns1__invoke(%p, %d, %s, %s)\n", (void*)soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct ns1__invoke *p;
	size_t k = sizeof(struct ns1__invoke);
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE_ns1__invoke, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct ns1__invoke);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct ns1__invoke, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns1__invoke location=%p n=%d\n", (void*)p, n));
	if (size)
		*size = k;
	if (!p)
		soap->error = SOAP_EOM;
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_default_SOAP_ENC__string(soap, &a->_invokeReturn);
}
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns1__invokeResponse(struct soap *soap, const struct ns1__invokeResponse *a)
{
	(void)soap; (void)a; /* appease -Wall -Werror */
#ifndef WITH_NOIDREF
	soap_serialize_SOAP_ENC__string(soap, &a->_invokeReturn);
#endif
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns1__invokeResponse(struct soap *soap, const char *tag, int id, const struct ns1__invokeResponse *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns1__invokeResponse), type))
		return soap->error;
	if (soap_out_SOAP_ENC__string(soap, "invokeReturn", -1, &a->_invokeReturn, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
...
SOAP_FMAC3 struct ns1__invokeResponse * SOAP_FMAC4 soap_in_ns1__invokeResponse(struct soap *soap, const char *tag, struct ns1__invokeResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, NULL))
		return NULL;
	(void)type; /* appease -Wall -Werror */
	a = (struct ns1__invokeResponse*)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns1__invokeResponse, sizeof(struct ns1__invokeResponse), soap->type, soap->arrayType, soap_instantiate, soap_fbase);
	if (!a)
		return NULL;
	...
	if (soap->body && *soap->href != '#')
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			...
			{	if (soap_in_SOAP_ENC__string(soap, NULL, &a->_invokeReturn, "SOAP-ENC:string"))
	...
	{	a = (struct ns1__invokeResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns1__invokeResponse, SOAP_TYPE_ns1__invokeResponse, sizeof(struct ns1__invokeResponse), 0, soap_finsert, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC1 struct ns1__invokeResponse * SOAP_FMAC2 soap_instantiate_ns1__invokeResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns1__invokeResponse(%p, %d, %s, %s)\n", (void*)soap, n, type?type:"", arrayType?arrayType:""));
	(void)type; (void)arrayType; /* appease -Wall -Werror */
	struct ns1__invokeResponse *p;
	size_t k = sizeof(struct ns1__invokeResponse);
	struct soap_clist *cp = soap_link(soap, SOAP_TYPE_ns1__invokeResponse, n, soap_fdelete);
	if (!cp && soap && n != SOAP_NO_LINK_TO_DELETE)
		return NULL;
	if (n < 0)
	{	p = SOAP_NEW(soap, struct ns1__invokeResponse);
	}
	else
	{	p = SOAP_NEW_ARRAY(soap, struct ns1__invokeResponse, n);
		k *= n;
	}
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "Instantiated struct ns1__invokeResponse location=%p n=%d\n", (void*)p, n));
	if (size)
		*size = k;
	if (!p)
		soap->error = SOAP_EOM;
