...
{
	if (::soap_read_SOAP_ENC__string(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
#endif
...
SOAP_FMAC1 struct ns1__invoke * SOAP_FMAC2 soap_instantiate_ns1__invoke(struct soap*, int, const char*, const char*, size_t*);

inline struct ns1__invoke * soap_new_ns1__invoke(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns1__invoke(soap, n, NULL, NULL, NULL);
}

inline struct ns1__invoke * soap_new_req_ns1__invoke(
	struct soap *soap,
	const std::string& _xmlData)
{
	struct ns1__invoke *_p = ::soap_new_ns1__invoke(soap);
	if (_p)
	{	::soap_default_ns1__invoke(soap, _p);
		_p->_xmlData = _xmlData;
	}
	return _p;
}

inline struct ns1__invoke * soap_new_set_ns1__invoke(
	struct soap *soap,
	const std::string& _xmlData)
{
	struct ns1__invoke *_p = ::soap_new_ns1__invoke(soap);
...
inline int soap_write_ns1__invoke(struct soap *soap, struct ns1__invoke const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_ns1__invoke(soap, p), 0) || ::soap_put_ns1__invoke(soap, p, "ns1:invoke", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns1__invoke(struct soap *soap, const char *URL, struct ns1__invoke const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns1__invoke(soap, p), 0) || ::soap_put_ns1__invoke(soap, p, "ns1:invoke", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_PATCH_ns1__invoke(struct soap *soap, const char *URL, struct ns1__invoke const*p)
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns1__invoke(soap, p), 0) || ::soap_put_ns1__invoke(soap, p, "ns1:invoke", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_ns1__invoke(struct soap *soap, const char *URL, struct ns1__invoke const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns1__invoke(soap, p), 0) || ::soap_put_ns1__invoke(soap, p, "ns1:invoke", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
SOAP_FMAC3 struct ns1__invoke * SOAP_FMAC4 soap_get_ns1__invoke(struct soap*, struct ns1__invoke *, const char*, const char*);

inline int soap_read_ns1__invoke(struct soap *soap, struct ns1__invoke *p)
{
	if (p)
	{	::soap_default_ns1__invoke(soap, p);
		if (soap_begin_recv(soap) || ::soap_get_ns1__invoke(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns1__invoke(struct soap *soap, const char *URL, struct ns1__invoke *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns1__invoke(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}

inline int soap_POST_recv_ns1__invoke(struct soap *soap, struct ns1__invoke *p)
{
	if (::soap_read_ns1__invoke(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
#endif
...
SOAP_FMAC1 struct ns1__invokeResponse * SOAP_FMAC2 soap_instantiate_ns1__invokeResponse(struct soap*, int, const char*, const char*, size_t*);

inline struct ns1__invokeResponse * soap_new_ns1__invokeResponse(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns1__invokeResponse(soap, n, NULL, NULL, NULL);
}

inline struct ns1__invokeResponse * soap_new_req_ns1__invokeResponse(
	struct soap *soap,
	const std::string& _invokeReturn)
{
	struct ns1__invokeResponse *_p = ::soap_new_ns1__invokeResponse(soap);
	if (_p)
	{	::soap_default_ns1__invokeResponse(soap, _p);
		_p->_invokeReturn = _invokeReturn;
	}
	return _p;
}

inline struct ns1__invokeResponse * soap_new_set_ns1__invokeResponse(
	struct soap *soap,
	const std::string& _invokeReturn)
{
	struct ns1__invokeResponse *_p = ::soap_new_ns1__invokeResponse(soap);
...
inline int soap_write_ns1__invokeResponse(struct soap *soap, struct ns1__invokeResponse const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (::soap_serialize_ns1__invokeResponse(soap, p), 0) || ::soap_put_ns1__invokeResponse(soap, p, "ns1:invokeResponse", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns1__invokeResponse(struct soap *soap, const char *URL, struct ns1__invokeResponse const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns1__invokeResponse(soap, p), 0) || ::soap_put_ns1__invokeResponse(soap, p, "ns1:invokeResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_PATCH_ns1__invokeResponse(struct soap *soap, const char *URL, struct ns1__invokeResponse const*p)
{
	soap_free_temp(soap);
	if (soap_PATCH(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns1__invokeResponse(soap, p), 0) || ::soap_put_ns1__invokeResponse(soap, p, "ns1:invokeResponse", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}

inline int soap_POST_send_ns1__invokeResponse(struct soap *soap, const char *URL, struct ns1__invokeResponse const*p)
{
	soap_free_temp(soap);
	if (soap_POST(soap, URL, NULL, "text/xml; charset=utf-8") || (::soap_serialize_ns1__invokeResponse(soap, p), 0) || ::soap_put_ns1__invokeResponse(soap, p, "ns1:invokeResponse", "") || soap_end_send(soap))
		return soap_closesock(soap);
	return SOAP_OK;
}
...
inline int soap_read_ns1__invokeResponse(struct soap *soap, struct ns1__invokeResponse *p)
{
	if (p)
	{	::soap_default_ns1__invokeResponse(soap, p);
		if (soap_begin_recv(soap) || ::soap_get_ns1__invokeResponse(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns1__invokeResponse(struct soap *soap, const char *URL, struct ns1__invokeResponse *p)
{
	if (soap_GET(soap, URL, NULL) || ::soap_read_ns1__invokeResponse(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}

inline int soap_POST_recv_ns1__invokeResponse(struct soap *soap, struct ns1__invokeResponse *p)
{
	if (::soap_read_ns1__invokeResponse(soap, p))
		return soap_closesock(soap);
	return soap_closesock(soap);
}
#endif
