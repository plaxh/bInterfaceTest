/* soapSCServiceSoapBindingService.h
...
#ifndef soapSCServiceSoapBindingService_H
#define soapSCServiceSoapBindingService_H
#include "soapH.h"

    class SOAP_CMAC SCServiceSoapBindingService {
      public:
        ...
        bool soap_own;
        /// Variables globally declared in SCService.h, if any
        /// Construct a service with new managing context
        SCServiceSoapBindingService();
        /// Copy constructor
        SCServiceSoapBindingService(const SCServiceSoapBindingService&);
        /// Construct service given a shared managing context
        SCServiceSoapBindingService(struct soap*);
        /// Constructor taking input+output mode flags for the new managing context
        SCServiceSoapBindingService(soap_mode iomode);
        /// Constructor taking input and output mode flags for the new managing context
        SCServiceSoapBindingService(soap_mode imode, soap_mode omode);
        /// Destructor deletes deserialized data and its managing context, when the context was allocated by the constructor
        virtual ~SCServiceSoapBindingService();
        /// Delete all deserialized data (with soap_destroy() and soap_end())
        virtual void destroy();
        /// Delete all deserialized data and reset to defaults
        virtual void reset();
        /// Initializer used by constructors
        virtual void SCServiceSoapBindingService_init(soap_mode imode, soap_mode omode);
        /// Return a copy that has a new managing context with the same engine state
        virtual SCServiceSoapBindingService *copy() SOAP_PURE_VIRTUAL_COPY;
        /// Copy assignment
        SCServiceSoapBindingService& operator=(const SCServiceSoapBindingService&);
        ...
        //
        /// Web service operation 'invoke' implementation, should return SOAP_OK or error code
        virtual int invoke(const std::string& _xmlData, std::string &_invokeReturn) SOAP_PURE_VIRTUAL;
    };
#endif
